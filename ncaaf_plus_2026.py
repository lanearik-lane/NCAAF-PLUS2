...
SCHEDULE = {
    ...
    2: [  # Week 2 — Sep 10-13, 2026 — VERIFIED from NCAA.com / CBS / fbschedules
        # ── THURSDAY Sep 10 ──────────────────────────────────────────────
        ...
        G("Western Kentucky","Georgia",      "Sat 12:45 PM","SEC+","SEC",    "Sanford Stadium, Athens GA"),
        # ── SATURDAY Sep 12 — Afternoon ──────────────────────────────────
        ...
        G("Sam Houston St","Georgia Tech",   "Sat 3:30 PM","ACCN","ACC",     "Bobby Dodd Stadium, Atlanta GA","FCS"),
        G("Michigan State","Florida",        "Sat 3:30 PM","CBS","SEC",      "Ben Hill Griffin Stadium (The Swamp), Gainesville FL"),
        G("Ole Miss","Kentucky",             "Sat 3:30 PM","CBS","SEC",      "Kroger Field, Lexington KY"),
        G("Virginia","Auburn",               "Sat 3:30 PM","ESPN+","SEC",    "Jordan-Hare Stadium, Auburn AL"),
        G("Minnesota","Kansas",              "Sat 3:30 PM","ESPN+","Big 12", "David Booth Kansas Memorial Stadium, Lawrence KS"),
        ...
        G("UMass","Miami OH",                "Sat 3:30 PM","ESPN+","MAC",    "Yager Stadium, Oxford OH"),
        ...
        G("Wisconsin","Minnesota",           "Sat 7:30 PM","BTN","Big Ten",  "Huntington Bank Stadium, Minneapolis MN"),
        G("TCU","SMU",                       "Sat 7:30 PM","ESPN+","ACC",    "Gerald J. Ford Stadium, Dallas TX"),
        # ── SATURDAY Sep 12 — Prime Time ─────────────────────────────────
        G("Ohio State","Texas",              "Sat 7:30 PM","ABC","SEC",      "Darrell K Royal Stadium, Austin TX"),
        G("Western Michigan","Michigan",     "Sat 7:30 PM","NBC","Big Ten",  "Michigan Stadium, Ann Arbor MI"),
        G("Charlotte","Cincinnati",          "Sat 7:30 PM","ESPN+","Big 12", "Nippert Stadium, Cincinnati OH"),
        # ── SATURDAY Sep 12 — Late Night ─────────────────────────────────
        G("North Dakota State","Air Force",  "Sat 10:00 PM","FS1","MWC",    "Falcon Stadium, Colorado Springs CO","FCS"),
        G("Arkansas","Utah",                 "Sat 10:15 PM","ESPN","Big 12", "Rice-Eccles Stadium, Salt Lake City UT"),
        G("Sacramento State","Fresno State", "Sat 10:00 PM","CBSSN","Pac-12","Bulldog Stadium, Fresno CA"),
        G("Montana State","Nevada",          "Sat 10:00 PM","CW","MWC",     "Mackay Stadium, Reno NV","FCS"),
        ...
        # ── FCS Saturday extras ───────────────────────────────────────────
        G("Stony Brook","Delaware",          "Sat 12:00 PM","ESPN+","CAA",   "Delaware Stadium, Newark DE","FCS"),
        G("Colgate","Fordham",               "Sat 1:00 PM","ESPN+","Patriot","Coffey Field, Bronx NY","FCS"),
        G("South Dakota","Eastern Washington","Sat 2:00 PM","ESPN+","MVFC",  "Roos Field, Cheney WA","FCS"),
        G("UC Davis","Cal Poly",             "Sat 3:00 PM","ESPN+","Big Sky","Spanos Stadium, San Luis Obispo CA","FCS"),
        G("Southern Illinois","Illinois State","Sat 3:00 PM","ESPN+","MVFC","Hancock Stadium, Normal IL","FCS"),
        G("Northern Iowa","Drake",           "Sat 3:00 PM","ESPN+","MVFC",   "Drake Stadium, Des Moines IA","FCS"),
        G("Weber State","Southern Utah",     "Sat 3:00 PM","ESPN+","Big Sky","Stewart Stadium, Ogden UT","FCS"),
        G("Mercer","Wofford",               "Sat 5:00 PM","ESPN+","SoCon",   "Gibbs Stadium, Spartanburg SC","FCS"),
        G("Tennessee Tech","Morehead State", "Sat 5:00 PM","ESPN+","OVC",    "Tucker Stadium, Cookeville TN","FCS"),
        G("Samford","Furman",               "Sat 6:00 PM","ESPN+","SoCon",   "Paladin Stadium, Greenville SC","FCS"),
        G("NC A&T","Norfolk State",          "Sat 5:00 PM","HBCUGO","MEAC",  "Dick Price Stadium, Norfolk VA","FCS"),
        # ── D-II Saturday ────────────────────────────────────────────────
        ...
        G("Shepherd","WV Wesleyan",          "Sat 1:00 PM","—","MEC",        "Weisenburger Stadium, Buckhannon WV","D-II"),
