...
SCHEDULE = {
    ...
    2: [  # Week 2 — Sep 12, 2026 — REAL FULL SLATE (all divisions)
        # ── FBS ──────────────────────────────────────────────────────────
        ...
        G("Kansas","Texas",                 "3:30 PM", "ESPN","SEC",     "Darrell K Royal Stadium, Austin TX"),
        G("Texas A&M","Alabama",            "3:30 PM", "CBS", "SEC",     "Bryant-Denny Stadium, Tuscaloosa AL"),
        G("Notre Dame","Michigan",          "3:30 PM", "NBC", "Big Ten", "Michigan Stadium, Ann Arbor MI"),
        G("Penn State","Ohio State",        "7:30 PM", "FOX", "Big Ten", "Ohio Stadium, Columbus OH"),
        G("Tennessee","Florida",            "3:30 PM", "CBS", "SEC",     "Ben Hill Griffin Stadium (The Swamp)"),
        G("Oregon State","Oregon",          "7:30 PM", "FS1", "Big Ten", "Autzen Stadium, Eugene OR"),
        ...
        G("Arizona","BYU",                  "10:00 PM","ESPN","Big 12",  "LaVell Edwards Stadium, Provo UT"),
        ...
        G("Tulsa","East Carolina",          "3:30 PM", "ESPN+","AAC",   "Dowdy-Ficklen Stadium, Greenville NC"),
        G("Rice","UTSA",                    "7:00 PM", "ESPN+","AAC",   "Alamodome, San Antonio TX"),
        G("Bowling Green","Nebraska",       "12:00 PM","BTN", "Big Ten", "Memorial Stadium, Lincoln NE"),
        G("Michigan State","Arizona State", "7:30 PM", "BTN", "Big Ten", "Spartan Stadium, East Lansing MI"),
        G("Illinois","Penn State",          "12:00 PM","BTN", "Big Ten", "Beaver Stadium, State College PA"),
        G("Oklahoma State","Tulsa",         "3:30 PM", "FS1", "Big 12",  "Boone Pickens Stadium, Stillwater OK"),
        G("Kansas State","Baylor",          "7:30 PM", "ESPN","Big 12",  "McLane Stadium, Waco TX"),
        G("Oklahoma","West Virginia",       "7:00 PM", "ESPN2","SEC",   "Darrell K Royal Stadium"),
        G("Utah State","Colorado State",    "9:00 PM", "FS1", "Pac-12", "Canvas Stadium, Fort Collins CO"),
        G("Air Force","San Diego State",    "10:00 PM","CBSSN","MWC",   "Falcon Stadium, Colorado Springs CO"),
        G("UNLV","North Texas",             "7:00 PM", "ESPN+","MWC",   "Allegiant Stadium, Las Vegas NV"),
        G("UCF","Pittsburgh",               "7:00 PM", "ACCN","ACC",    "Acrisure Stadium, Pittsburgh PA"),
        G("Duke","Illinois",                "3:30 PM", "ESPN+","ACC",   "Memorial Stadium, Champaign IL"),
        G("North Texas","Rice",             "7:00 PM", "ESPN+","AAC",   "Rice Stadium, Houston TX"),
        G("Florida Atlantic","Florida",     "7:45 PM", "SEC+","SEC",    "Ben Hill Griffin Stadium"),
        G("Charlotte","Florida International","7:00 PM","ESPN+","AAC",  "FIU Stadium, Miami FL"),
        G("Louisiana Monroe","South Alabama","7:00 PM","ESPN+","Sun Belt","Hancock Whitney Stadium, Mobile AL"),
        G("Old Dominion","Georgia Southern","3:30 PM","ESPN+","Sun Belt","Paulson Stadium, Statesboro GA"),
        G("Texas State","Louisiana Tech",   "7:30 PM","ESPN+","CUSA",   "Joe Aillet Stadium, Ruston LA"),
        G("Maryland","Virginia Tech",       "12:00 PM","BTN","Big Ten", "Lane Stadium, Blacksburg VA"),
        G("North Carolina","Wake Forest",   "3:30 PM","ACCN","ACC",     "Truist Field, Winston-Salem NC"),
        G("Syracuse","Virginia",            "12:00 PM","ESPN+","ACC",   "Scott Stadium, Charlottesville VA"),
        G("Wisconsin","Purdue",             "3:30 PM","BTN","Big Ten",  "Ross-Ade Stadium, West Lafayette IN"),
        G("Iowa","Iowa State",              "3:30 PM","ESPN","Big Ten/Big 12","Kinnick Stadium, Iowa City IA"),
        G("Minnesota","Northwestern",       "12:00 PM","BTN","Big Ten", "Ryan Field, Evanston IL"),
        G("Rutgers","Michigan State",       "12:00 PM","BTN","Big Ten", "Spartan Stadium, East Lansing MI"),
        G("Indiana","UCLA",                 "7:30 PM","ESPN","Big Ten",  "Rose Bowl, Pasadena CA"),
        G("Washington","Oregon State",      "10:00 PM","FS1","Big Ten", "Reser Stadium, Corvallis OR"),
        G("Cal","Stanford",                 "7:30 PM","ACCN","ACC",     "Stanford Stadium, Palo Alto CA"),
        G("Georgia Tech","Clemson",         "3:30 PM","ESPN+","ACC",    "Memorial Stadium, Clemson SC"),
        G("SMU","Virginia Tech",            "12:00 PM","ESPN","ACC",    "Lane Stadium, Blacksburg VA"),
        G("Louisville","Pittsburgh",        "7:00 PM","ESPN","ACC",     "Acrisure Stadium, Pittsburgh PA"),
        G("Memphis","Navy",                 "7:00 PM","ESPN+","AAC",    "Navy-Marine Corps Memorial Stadium, Annapolis MD"),
        G("Fresno State","UTEP",            "9:00 PM","ESPN+","Pac-12", "Sun Bowl, El Paso TX"),
        G("Wyoming","Boise State",          "9:00 PM","FS1","Pac-12",   "Albertsons Stadium, Boise ID"),
        G("Nevada","Hawaii",                "10:00 PM","ESPN+","MWC",   "Clarence T.C. Ching Athletics Complex, Honolulu HI"),
        G("New Mexico","UNLV",              "10:00 PM","ESPN+","MWC",   "Allegiant Stadium, Las Vegas NV"),
        G("USC","UL Lafayette",             "11:00 PM","ESPN+","Big Ten","Cajundome, Lafayette LA"),
        # ── FCS ──────────────────────────────────────────────────────────
        G("Michigan","Gardner Webb",        "12:00 PM","BTN","Big Ten", "Michigan Stadium, Ann Arbor MI","FCS"),
        G("Wagner","James Madison",         "12:00 PM","ESPN+","Sun Belt","Bridgeforth Stadium, Harrisonburg VA","FCS"),
        G("Army","South Florida",           "3:30 PM","ESPN+","AAC",    "Raymond James Stadium, Tampa FL","FCS"),
        G("Washington State","Kansas State","12:00 PM","ESPN+","Big 12","Bill Snyder Family Stadium","FCS"),
        G("Elon","Campbell",                "12:00 PM","FloSports","CAA","Joseph T. Bristol Stadium, Buies Creek NC","FCS"),
        G("Rhode Island","Appalachian St",  "12:00 PM","ESPN+","Sun Belt","Kidd Brewer Stadium, Boone NC","FCS"),
        G("East Carolina","Florida",        "3:30 PM","ESPN+","SEC",    "Ben Hill Griffin Stadium","FCS"),
        G("North Carolina A&T","North Carolina Central","12:00 PM","HBCUGO","MEAC","O'Kelly-Riddick Stadium, Durham NC","FCS"),
        G("Howard","Indiana",               "3:30 PM","BTN","Big Ten",  "Memorial Stadium, Bloomington IN","FCS"),
        G("Marist","Lafayette",             "12:00 PM","ESPN+","Patriot","Fisher Stadium, Easton PA","FCS"),
        G("Bucknell","VMI",                 "12:00 PM","ESPN+","Patriot","Alumni Memorial Field, Lewisburg PA","FCS"),
        G("Western Kentucky","South Florida","7:00 PM","ESPN+","AAC",   "Raymond James Stadium, Tampa FL","FCS"),
        G("Western Carolina","Georgia",     "12:00 PM","SEC+","SEC",    "Sanford Stadium, Athens GA","FCS"),
        G("Colgate","Central Michigan",     "1:00 PM","ESPN+","MAC",    "Kelly/Shorts Stadium, Mount Pleasant MI","FCS"),
        G("UT Martin","West Virginia",      "12:00 PM","ESPN+","SEC",   "Milan Puskar Stadium, Morgantown WV","FCS"),
        G("Holy Cross","Stony Brook",       "1:00 PM","FloSports","CAA","LaValle Stadium, Stony Brook NY","FCS"),
        G("Duquesne","Youngstown State",    "2:00 PM","ESPN+","MVFC",   "Stambaugh Stadium, Youngstown OH","FCS"),
        G("Ball State","Texas",             "12:00 PM","ESPN","SEC",    "Darrell K Royal Stadium, Austin TX","FCS"),
        G("William & Mary","Lehigh",        "1:00 PM","ESPN+","Patriot","Murray H. Goodman Stadium, Bethlehem PA","FCS"),
        G("Drake","Northern Iowa",          "2:00 PM","ESPN+","MVFC",   "UNI-Dome, Cedar Falls IA","FCS"),
        G("Eastern Washington","South Dakota","2:00 PM","ESPN+","MVFC", "DakotaDome, Vermillion SD","FCS"),
        G("Utah Tech","Montana",            "3:00 PM","ESPN+","Big Sky","Washington-Grizzly Stadium, Missoula MT","FCS"),
        G("Montana State","UC Davis",       "3:00 PM","ESPN+","Big Sky","Bobcat Stadium, Bozeman MT","FCS"),
        G("Weber State","Colorado",         "3:30 PM","ESPN+","Big 12", "Folsom Field, Boulder CO","FCS"),
        G("Maryland","UConn",               "12:00 PM","BTN","Big Ten", "Rentschler Field, East Hartford CT","FCS"),
        G("Rice","North Dame",              "7:30 PM","NBC","Ind.",      "Notre Dame Stadium, South Bend IN","FCS"),
        G("Sacred Heart","UMass",           "3:30 PM","ESPN+","Sun Belt","Warren McGuirk Alumni Stadium, Amherst MA","FCS"),
        G("Illinois","Duke",                "3:30 PM","ESPN+","ACC",    "Wallace Wade Stadium, Durham NC","FCS"),
        G("UCF","Pittsburgh",               "7:00 PM","ACCN","ACC",     "Acrisure Stadium, Pittsburgh PA","FCS"),
        G("Central Connecticut","Toledo",   "3:30 PM","ESPN+","MAC",    "Glass Bowl, Toledo OH","FCS"),
        G("North Texas","UNLV",             "7:00 PM","ESPN+","MWC",    "Allegiant Stadium, Las Vegas NV","FCS"),
        G("Stetson","Bethune Cookman",      "4:00 PM","ESPN+","SWAC",   "Bragg Memorial Stadium, Tallahassee FL","FCS"),
        G("UC Davis","SMU",                 "7:30 PM","ESPN+","ACC",    "Gerald J. Ford Stadium, Dallas TX","FCS"),
        G("Mercyhurst","New Mexico",        "7:00 PM","ESPN+","MWC",    "University Stadium, Albuquerque NM","FCS"),
        G("Alabama State","Troy",           "6:00 PM","ESPN+","Sun Belt","Veterans Memorial Stadium, Troy AL","FCS"),
        G("Lamar","Idaho",                  "7:00 PM","ESPN+","Big Sky", "Kibbie Dome, Moscow ID","FCS"),
        G("Northern Colorado","Wyoming",    "7:00 PM","FS1","MWC",      "War Memorial Stadium, Laramie WY","FCS"),
        G("Delaware","Vanderbilt",          "4:00 PM","ESPN+","SEC",    "FirstBank Stadium, Nashville TN","FCS"),
        G("Merrimack","Maine",              "1:00 PM","ESPN+","CAA",    "Alfond Stadium, Orono ME","FCS"),
        G("Morehead State","Austin Peay",   "2:00 PM","ESPN+","OVC",    "Fortera Stadium, Clarksville TN","FCS"),
        G("Incarnate Word","Northern Arizona","4:00 PM","ESPN+","Big Sky","Walkup Skydome, Flagstaff AZ","FCS"),
        G("Campbell","Florida",             "3:30 PM","ESPN+","SEC",    "Ben Hill Griffin Stadium, Gainesville FL","FCS"),
        G("Memphis","Boise State",          "7:30 PM","FS1","Pac-12",   "Albertsons Stadium, Boise ID","FCS"),
        G("Charleston Southern","Citadel",  "6:00 PM","ESPN+","SoCon",  "Johnson Hagood Stadium, Charleston SC","FCS"),
        G("Furman","Mercer",                "6:00 PM","ESPN+","SoCon",  "Five Star Stadium, Macon GA","FCS"),
        G("Buffalo","FIU",                  "7:00 PM","ESPN+","AAC",    "FIU Stadium, Miami FL","FCS"),
        G("Stonehill","New Hampshire",      "1:00 PM","ESPN+","CAA",    "Cowell Stadium, Durham NH","FCS"),
        G("Bryant","Hampton",               "1:00 PM","ESPN+","CAA",    "Hampton Stadium, Hampton VA","FCS"),
        G("San Diego State","Idaho State",  "7:00 PM","ESPN+","MWC",    "Holt Arena, Pocatello ID","FCS"),
        G("North Dakota St","Air Force",    "9:00 PM","ESPN+","MWC",    "Falcon Stadium, Colorado Springs CO","FCS"),
        G("North Dakota","Portland State",  "4:00 PM","ESPN+","Big Sky", "Viking Stadium, Portland OR","FCS"),
        G("Arkansas","Montana State",       "3:00 PM","ESPN+","Big Sky", "Bobcat Stadium, Bozeman MT","FCS"),
        G("Utah","Montana State",           "3:30 PM","ESPN+","Big Sky", "Bobcat Stadium, Bozeman MT","FCS"),
        G("Nevada","Sacramento State",      "9:00 PM","ESPN+","Big Sky", "Hornet Stadium, Sacramento CA","FCS"),
        G("Fresno State","Samford",         "9:00 PM","ESPN+","SoCon",  "Seibert Stadium, Birmingham AL","FCS"),
        G("UL Lafayette","USC",             "11:00 PM","ESPN+","Big Ten","LA Memorial Coliseum, Los Angeles CA","FCS"),
        # ── D-II ─────────────────────────────────────────────────────────
        G("Samford","Tennessee Tech",       "7:00 PM","ESPN+","SoCon",  "Tucker Stadium, Cookeville TN","D-II"),
        G("New Haven","South Dakota St",    "4:00 PM","ESPN+","MVFC",   "Dana J. Dykhouse Stadium, Brookings SD","D-II"),
        G("Southern Utah","Colorado State", "7:00 PM","ESPN+","Pac-12", "Canvas Stadium, Fort Collins CO","D-II"),
        G("Bowling Green","Nebraska",       "12:00 PM","BTN","Big Ten",  "Memorial Stadium, Lincoln NE","D-II"),
        G("Western Carolina","Cincinnati",  "3:30 PM","ESPN+","Big 12", "Nippert Stadium, Cincinnati OH","D-II"),
        G("Middle Tennessee","Marshall",    "7:00 PM","ESPN+","Sun Belt","Joan C. Edwards Stadium, Huntington WV","D-II"),
        G("Tennessee State","Alabama A&M",  "3:00 PM","ESPN+","SWAC",   "Louis Crews Stadium, Huntsville AL","D-II"),
        G("Southern","Houston",             "7:30 PM","ESPN+","AAC",    "TDECU Stadium, Houston TX","D-II"),
        G("Illinois State","Northern Illinois","7:00 PM","ESPN+","MAC", "Huskie Stadium, DeKalb IL","D-II"),
        G("North Alabama","Southeastern Louisiana","7:00 PM","ESPN+","Southland","Strawberry Stadium, Hammond LA","D-II"),
        G("UT Rio Grande Valley","Nichols State","7:30 PM","ESPN+","Southland","John L. Guidry Stadium, Thibodaux LA","D-II"),
        G("Tulsa","Sam Houston State",      "7:00 PM","ESPN+","AAC",    "Bowers Stadium, Huntsville TX","D-II"),
        G("Indiana State","Eastern Illinois","7:00 PM","ESPN+","OVC",   "O'Brien Field, Charleston IL","D-II"),
        G("Tarleton State","McNeese State", "7:00 PM","ESPN+","Southland","Cowboy Stadium, Lake Charles LA","D-II"),
        G("McNeese State","Tennessee",      "3:30 PM","ESPN+","SEC",    "Neyland Stadium, Knoxville TN","D-II"),
        G("Georgia State","Kennesaw State", "7:00 PM","ESPN+","CUSA",   "Fifth Third Stadium, Kennesaw GA","D-II"),
        G("Southeast Missouri State","Southern Illinois","7:00 PM","ESPN+","MVFC","Saluki Stadium, Carbondale IL","D-II"),
        G("South Alabama","Tulane",         "7:30 PM","ESPN+","AAC",    "Yulman Stadium, New Orleans LA","D-II"),
        G("Georgia Tech","Tennessee",       "7:30 PM","ESPN+","SEC",    "Neyland Stadium, Knoxville TN","D-II"),
        G("Wisconsin","Incarnate Word",     "3:30 PM","BTN","Big Ten",  "Camp Randall Stadium, Madison WI","D-II"),
        G("Prairie View A&M","Baylor",      "7:00 PM","ESPN+","Big 12", "McLane Stadium, Waco TX","D-II"),
        # ── D-III ────────────────────────────────────────────────────────
        G("Cal Poly","San Jose State",      "9:00 PM","ESPN+","Big Ten", "CEFCU Stadium, San Jose CA","D-III"),
        G("North Dakota State","Air Force", "9:00 PM","ESPN+","MWC",    "Falcon Stadium, Colorado Springs CO","D-III"),
        G("Portland State","North Dakota",  "4:00 PM","ESPN+","Big Sky", "Alerus Center, Grand Forks ND","D-III"),
        G("Arkansas","Montana",             "3:30 PM","ESPN+","Big Sky", "Washington-Grizzly Stadium, Missoula MT","D-III"),
        G("Utah","Montana State",           "3:30 PM","ESPN+","Big Sky", "Bobcat Stadium, Bozeman MT","D-III"),
        G("Nevada","Sacramento State",      "9:00 PM","ESPN+","Big Sky", "Hornet Stadium, Sacramento CA","D-III"),
        G("Fresno State","Samford",         "9:00 PM","ESPN+","SoCon",  "Seibert Stadium, Birmingham AL","D-III"),
        G("UL Lafayette","USC",             "11:00 PM","ESPN+","Big Ten","LA Memorial Coliseum, Los Angeles CA","D-III"),
    ],
    3: [  # Week 3 — Sep 17-20
