...
# Real games by date (used as fallback when APIs fail)
TOMORROW = "Aug 28"  # Friday Aug 28 — ESPN's first broadcast day

STATIC_BY_DATE = {
    # Friday Aug 28, 2026 — FCS Opening Night (real confirmed games)
    "2026-08-28": [
    ...
    # Saturday Aug 29, 2026 — FBS Week Zero + more FCS (real confirmed games)
    "2026-08-29": [
        # FBS
        normalize_game("North Carolina","TCU",       "12:00 PM","ESPN",  "Aviva Stadium — Dublin, Ireland","Neutral",neutral=True),
        normalize_game("Southern","Alabama State",   "3:00 PM", "ESPNU", "Legion Field — Birmingham AL",  "SWAC"),
        normalize_game("NC State","Virginia",        "3:30 PM", "ESPN",  "Scott Stadium, Charlottesville VA","ACC"),
        normalize_game("San Jose State","USC",       "3:00 PM", "NBC",   "LA Memorial Coliseum, Los Angeles","Big Ten"),
        normalize_game("Jacksonville St","North Dakota St","5:30 PM","CBSSN","Fargodome, Fargo ND","MWC"),
        normalize_game("Sacramento St","Eastern Michigan","6:30 PM","ESPN+","Rynearson Stadium, Ypsilanti MI","MAC"),
        normalize_game("East Texas A&M","Mercer",   "7:00 PM", "ESPN",  "Five Star Stadium, Macon GA",   "FCS Kickoff", div="FCS"),
        normalize_game("Hawaii","Stanford",          "7:00 PM", "ACCN",  "Stanford Stadium, Palo Alto CA","ACC"),
        normalize_game("New Mexico State","Florida State","7:00 PM","CW","Doak Campbell Stadium, Tallahassee FL","ACC"),
        normalize_game("Tarleton State","Prairie View A&M","9:00 PM","ESPN2","Memorial Stadium, Stephenville TX","UAC", div="FCS"),
        normalize_game("Memphis","UNLV",             "10:00 PM","FOX",   "Allegiant Stadium, Las Vegas NV","MWC"),
    ],
}

# ESPN week number → static fallback games (FBS+FCS combined)
STATIC = {
